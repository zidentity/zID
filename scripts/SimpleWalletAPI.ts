...
import { BaseApiParams, BaseWalletAPI } from '../contracts/lib/bundler/packages/sdk/src/BaseWalletAPI'
 ...
 */
export interface zkWalletApiParams extends BaseApiParams {
 ...
 */
export class zkWalletAPI extends BaseWalletAPI {
  factoryAddress?: string
  index: number
  ...
  constructor (params: zkWalletApiParams) {
    super(params)
  ...
  async signRequestId (requestId: string): Promise<string> {
    return requestId // returns encoded zkProof 
  }
